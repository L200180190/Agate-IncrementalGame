...
public class GameManager : MonoBehaviour
{
    ...
    private void Update()
    {
        // Fungsi untuk selalu mengeksekusi CollectPerSecond tiap detik
    ...
    private void CollectPerSecond()
    {
        ...
        // Fungsi ToString("F1") adalah membulatkan angka menjadi desimal dengan angka 1 di belakang koma
